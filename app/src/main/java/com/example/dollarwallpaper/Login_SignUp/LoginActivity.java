...
import com.example.dollarwallpaper.MainActivity;
import com.example.dollarwallpaper.R;
import com.example.dollarwallpaper.databinding.ActivityLoginBinding;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.facebookBtn.setVisibility(View.GONE);*/
        binding.googleBtn.setVisibility(View.INVISIBLE);
        binding.facebookBtn.setVisibility(View.INVISIBLE);
